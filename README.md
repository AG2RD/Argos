...
Personnal development assistant.

V0.x.x: Study case to develop desktop app with electron & co technologies.
Based on architecture of Maxime Gris's angular-electron project in order to waist time and avoid js fatigue.

V1.x.x: Rewrite project from a  personnal electron-angular seed + electron project generator based on existant similar projects.


## ---------------------------------------------------------------
## Introduction of angular-electron project
